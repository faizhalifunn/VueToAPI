<template>
    <div class="h-screen flex flex-col items-center justify-center bg-black text-gray-800">
      <div class="bg-gray-200 rounded-2xl shadow-md p-6 w-full max-w-3xl">
        ...
        <!-- Chart Wrapper (Agar Chart Tidak Terlalu Besar) -->
        <div class="chart-container size-max">
  ...
  export default {
    ...
    setup() {
      ...
      return { gameCode, sortedTeams, formatNumber, isLoading, chartCanvas };
    },
  };
  </script>
